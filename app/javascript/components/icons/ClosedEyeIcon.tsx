...
const ClosedEyeIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 110 107" fill="none">
            ...
            <line x1="10" y1="10" x2="100" y2="97" stroke="#26C9C3" strokeWidth="10" strokeLinecap="round" />
        </svg>
    );
};
